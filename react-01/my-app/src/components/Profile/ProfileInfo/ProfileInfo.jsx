  ...
  return (
    <div className={styles.info}>
      ...
      <div className={styles.profile__desc}>
        <img src={props.profile.photos.small ? props.profile.photos.small : 'https://st3.depositphotos.com/3431221/13621/v/450/depositphotos_136216036-stock-illustration-man-avatar-icon-hipster-character.jpg'}></img>
